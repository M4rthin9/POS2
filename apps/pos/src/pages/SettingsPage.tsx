      ...
      <div className="p-4 max-w-xl mx-auto w-full flex-1">
        <div className="bg-white rounded-xl shadow-sm p-4 space-y-3">
          <label className="block">
            ...
            <input value={settings.org_name} onChange={(e) => set('org_name', e.target.value)} className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-800" />
          </label>
          <label className="block">
            <span className="text-sm font-medium text-slate-600">{TH.orgSubtitle}</span>
            <input value={settings.org_subtitle} onChange={(e) => set('org_subtitle', e.target.value)} className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-800" />
          </label>
          <label className="block">
            <span className="text-sm font-medium text-slate-600">{TH.orgAddress}</span>
            <input value={settings.org_address} onChange={(e) => set('org_address', e.target.value)} className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-800" />
          </label>
          <label className="block">
            <span className="text-sm font-medium text-slate-600">{TH.taxId}</span>
            <input value={settings.tax_id} onChange={(e) => set('tax_id', e.target.value)} className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-800" />
          </label>
          <label className="block">
            <span className="text-sm font-medium text-slate-600">{TH.receiptFooter}</span>
            <input value={settings.receipt_footer} onChange={(e) => set('receipt_footer', e.target.value)} className="mt-1 w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-800" />
          </label>
          ...
          <button onClick={save} className="w-full py-3 rounded-xl bg-slate-800 text-white font-bold hover:bg-slate-700">
            {TH.save}
          </button>
        </div>
      </div>
