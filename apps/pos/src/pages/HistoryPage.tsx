...
export default function HistoryPage() {
  ...
  // Set by the report card, so the listed bills always match the round shown.
  const [round, setRound] = useState<ReportRound | null>(null);
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col">
      ...
      <div className="p-4 max-w-3xl mx-auto w-full flex-1 space-y-3">
        <RoundReport onRoundChange={setRound} reloadTick={reloadTick} />
