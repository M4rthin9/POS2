...
export const TH = {
  ...
  btFallbackNotice: 'เครื่องพิมพ์ความร้อนไม่พร้อมใช้งาน — ใช้เครื่องพิมพ์ปกติแทน (เลือกเครื่องพิมพ์ในกล่องโต้ตอบ)',
  normalPrinterTest: 'ทดสอบพิมพ์ (เครื่องพิมพ์ปกติ)',
  normalPrinterHint: 'เลือกเครื่องพิมพ์จากกล่องโต้ตอบของเบราว์เซอร์',
  ...
  darkTag: 'พื้นหลังดำ (โหมดมืด)',
  darkTagHint: 'พิมพ์พื้นหลังสีดำ ตัวอักษรและภาพเป็นสี — ในหน้าต่างพิมพ์ต้องเปิด "กราฟิกพื้นหลัง" ด้วย',
